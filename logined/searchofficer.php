...
<body class="bodi">
    <center>
    <h2> Search officers </h2>
    <div class = "header" style="background-color:black ;" style ="width: 600px;">
    <a href="officers.php" style="color: white;" class="q">Back!</a>
    </div>
    ...
    <button type="submit" class="form-control" name="btn">Search officer</button>
            ...
            <?php
                ...
                if (isset($btn)) {
                    ...
                    else
                    {
                        ...
                        $fname = $_POST['Fname'];
                        $img = mysqli_query($conn, "SELECT * FROM `officer` WHERE `fio` LIKE '$fname' ");
                        ...
                        <table class = "table">
                            <tr>                   
                                ...
                                <td> <a href="updateofficer.php?id=' . $img[0]. '">Update</a></td>         
                            </tr>
                        </table>                        
                            ';
                        }
